...
class Dependency
{
    ...
    /* PHP extensions (mandatory) */
       ...
       'installSourceUrl' => "http://www.smarty.net/files/Smarty-2.6.28.tar.gz",
...
#       'installSourceUrl' => "http://iweb.dl.sourceforge.net/sourceforge/phpmailer/PHPMailer_v5.1.tar.gz",
       'installSourceUrl' => "https://github.com/PHPMailer/PHPMailer/archive/phpmailer-5.1.tar.gz",
       'installMethod' => "tarball",
       'installDestination' => "/"
       ),
...
#       'installSourceUrl' => "http://easynews.dl.sourceforge.net/sourceforge/fckeditor/FCKeditor_2.5.tar.gz",
       'installSourceUrl' => "http://jaist.dl.sourceforge.net/project/fckeditor/FCKeditor/2.6.11/FCKeditor_2.6.11.zip",
       'installMethod' => "tarball",
       'installDestination' => "/",
       ),
